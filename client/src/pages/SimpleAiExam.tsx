...
export default function SimpleAiExam() {
          ...
          <CardHeader>
            <div className="flex justify-between items-start">
              <div>
                ...
                <CardDescription>AI Technical Assessment</CardDescription>
              </div>
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                <h3 className="font-semibold text-xl mb-4 text-gray-900">{currentQuestion.question}</h3>
              ...
              <div className="space-y-4">
                ...
                <Textarea
                  ...
                  className="min-h-[300px] resize-none border-2 border-gray-300 focus:border-blue-500 p-6 text-base"
                  rows={15}
                />
