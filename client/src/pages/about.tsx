  ...
  return (
    <>
      ...
      <main id="main-content" className="bg-cream-soft text-slate-900">
        <section className="border-b border-cream-deep bg-gradient-to-b from-slate-50 to-white">
          <div className="max-w-5xl mx-auto px-6 py-16 sm:py-24">
            <p className="text-sm font-semibold uppercase tracking-wider text-slate-700">About Octamy</p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/courses">
                <Button className="bg-slate-700 hover:bg-slate-800 text-white">Browse assessments</Button>
              </Link>
        ...
        <section className="max-w-5xl mx-auto px-6 py-16">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            />
            <Feature
              icon={<Users2 className="w-6 h-6 text-slate-700" />}
        ...
        <section className="bg-cream-deep border-y border-cream-deep">
          <div className="max-w-5xl mx-auto px-6 py-16">
            ...
            <p className="mt-4 text-slate-700 max-w-3xl">
              ...
              <a className="text-slate-700 underline" href="mailto:legal@octamy.com">legal@octamy.com</a>.
            </p>
            <div className="mt-6 flex flex-wrap gap-x-6 gap-y-2 text-sm">
              <Link href="/trust" className="text-slate-700 hover:underline">Trust & Compliance</Link>
              <Link href="/privacy-policy" className="text-slate-700 hover:underline">Privacy Policy</Link>
              <Link href="/terms-of-service" className="text-slate-700 hover:underline">Terms of Service</Link>
              <Link href="/refund-policy" className="text-slate-700 hover:underline">Refund Policy</Link>
              <Link href="/disclaimer" className="text-slate-700 hover:underline">Disclaimer</Link>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-5xl mx-auto px-6 py-16">
          ...
          <ul className="mt-4 space-y-2 text-slate-700">
            <li>General support: <a className="text-slate-700 underline" href="mailto:support@octamy.com">support@octamy.com</a></li>
            <li>Grievance officer: <a className="text-slate-700 underline" href="mailto:grievance@octamy.com">grievance@octamy.com</a></li>
            <li>Legal & compliance: <a className="text-slate-700 underline" href="mailto:legal@octamy.com">legal@octamy.com</a></li>
            <li>Partnerships: <a className="text-slate-700 underline" href="mailto:partners@octamy.com">partners@octamy.com</a></li>
          </ul>
        </section>
      </main>
      <Footer />
