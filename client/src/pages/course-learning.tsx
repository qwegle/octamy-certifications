      ...
      <main id="main-content">
        ...
        <section className="mx-auto grid max-w-7xl gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:px-8">
          <div className="min-w-0">
            ...
            {access?.productType === "bundle" && <Card className="mt-6 border-violet-200 bg-violet-50"><CardContent className="flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between"><div><h2 className="font-black text-violet-950">Ready to validate the skill?</h2><p className="mt-1 text-sm text-violet-900/70">The assessment and optional credential remain separate from course-content access.</p></div><Link href={`/assessments/${course.slug}`}><Button className="bg-violet-700 text-white">Take assessment</Button></Link></CardContent></Card>}
          </div>
