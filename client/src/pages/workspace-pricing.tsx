...
import { normalizePracticePassCycle } from '@/lib/practice-purchase-intent';
  ...
  return (
    <div className="min-h-screen bg-cream-soft flex flex-col">
      <SEO
        ...
        description="Creator, institute, and recruiter workspace pricing on Octamy. Practice Pass and certification credential pricing are explained separately."
        path="/pricing/workspaces"
      />
      <Header />
