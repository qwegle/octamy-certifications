...
const NAV_BY_ROLE: Record<DashboardRole, NavItem[]> = {
  institute: [
    ...
    { label: "Certification vouchers", href: "/institute/vouchers", icon: TicketCheck, group: "Manage" },
    { label: "Coupons", href: "/institute/coupons", icon: Tags, group: "Money" },
  ...
  creator: [
    ...
    { label: "Certification vouchers", href: "/creator/vouchers", icon: TicketCheck, group: "Manage" },
    { label: "Coupons", href: "/creator/coupons", icon: Tags, group: "Money" },
