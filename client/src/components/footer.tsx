      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <span className="text-2xl font-bold text-white mb-4 block">octamy</span>
            <p className="text-gray-300 mb-6 max-w-md">
              Professional certification platform helping individuals advance their careers with industry-recognized credentials.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:support@octamy.com" className="text-gray-300 hover:text-white transition-colors">
                  Contact Support
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-300">&copy; 2024 Octamy. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
