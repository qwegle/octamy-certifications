...
export function AdminCertificationBenefits() {
  ...
  return <Tabs defaultValue="vouchers" className="space-y-5">
    ...
    <TabsContent value="vouchers" className="space-y-5">
      <Card className="border-slate-200"><CardHeader className="border-b border-slate-100 bg-slate-50/60"><CardTitle className="flex items-center gap-2 text-lg"><TicketCheck className="h-5 w-5 text-slate-700" />Issue voucher allocation</CardTitle><p className="text-sm leading-6 text-slate-600">Codes are revealed once and downloaded immediately. Every redemption is course-scoped, expiry-controlled, and audited.</p></CardHeader><CardContent className="grid gap-4 p-5 md:grid-cols-2 xl:grid-cols-3">
