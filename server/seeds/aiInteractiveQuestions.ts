...
export async function seedAiInteractiveQuestions() {
  try {
    console.log("Seeding AI Interactive Questions...");

    // Create AI Interactive courses
    const aiCourses = [
      {
        title: "AI Problem Solving & Algorithms",
        description: "Advanced AI-powered assessment testing algorithmic thinking and problem-solving skills through interactive conversations.",
        slug: "ai-problem-solving-algorithms",
        categoryId: 5, // AI category
        duration: 90,
        passingScore: 70,
        price: "299.00",
      ...
      },
      {
        ...
        slug: "fullstack-development-assessment",
        categoryId: 2, // Development category
        duration: 120,
        passingScore: 75,
        price: "399.00",
        courseType: "ai_interactive",
      ...
      {
        title: "Data Structures & System Design",
        ...
        slug: "data-structures-system-design",
        categoryId: 2, // Development category
        duration: 100,
        passingScore: 72,
        price: "349.00",
    ...
    // Insert courses
    const insertedCourses = await db.insert(courses).values(aiCourses).returning();

    // AI Interactive Questions for each course
    const aiQuestions = [
      // AI Problem Solving & Algorithms Course
      {
      ...
      // Full Stack Development Assessment Course
      {
      ...
      // Data Structures & System Design Course
      {
    ...
    console.error("Error seeding AI interactive questions:", error);
    throw error;
  }
}